...
const WhatsAppIcon = () => (
  <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4">
    ...
    <path d="M12 0C5.373 0 0 5.373 0 12c0 2.123.554 4.118 1.528 5.855L0 24l6.335-1.508A11.946 11.946 0 0 0 12 24c6.627 0 12-5.373 12-12S18.627 0 12 0zm0 22c-1.885 0-3.65-.489-5.19-1.345l-.372-.22-3.862.92.978-3.768-.242-.387A9.96 9.96 0 0 1 2 12C2 6.477 6.477 2 12 2s10 4.477 10 10-4.477 10-10 10z" />
  </svg>
);
...
const TripAdvisorIcon = () => (
  <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4">
    <path d="M12 2C6.477 2 2 6.477 2 12s4.477 10 10 10 10-4.477 10-10S17.523 2 12 2zm0 3a3 3 0 1 1 0 6 3 3 0 0 1 0-6zm-5.5 8.5a2 2 0 1 1 0 4 2 2 0 0 1 0-4zm11 0a2 2 0 1 1 0 4 2 2 0 0 1 0-4zM12 14c-1.5 0-2.8.6-3.75 1.57l-.53-.94A6.97 6.97 0 0 1 12 13c1.62 0 3.1.55 4.28 1.63l-.53.94A4.97 4.97 0 0 0 12 14z" />
  </svg>
);
...
const VisaIcon = () => (
  <svg viewBox="0 0 48 48" className="h-5 w-auto" fill="none">
    <rect width="48" height="48" rx="6" fill="#1A1F71" />
    <text x="7" y="31" fontFamily="Arial" fontWeight="bold" fontSize="16" fill="white">VISA</text>
  </svg>
);
const MastercardIcon = () => (
  <svg viewBox="0 0 48 48" className="h-5 w-auto" fill="none">
    ...
    <path d="M24 16.26a10 10 0 0 1 0 15.48 10 10 0 0 1 0-15.48z" fill="#FF5F00" />
  </svg>
);
const PaypalIcon = () => (
  <svg viewBox="0 0 48 48" className="h-5 w-auto" fill="none">
    <rect width="48" height="48" rx="6" fill="#003087" />
    <text x="7" y="31" fontFamily="Arial" fontWeight="bold" fontSize="13" fill="#009CDE">Pay</text>
    <text x="22" y="31" fontFamily="Arial" fontWeight="bold" fontSize="13" fill="white">Pal</text>
  </svg>
);
const MpesaIcon = () => (
  <svg viewBox="0 0 48 48" className="h-5 w-auto" fill="none">
    <rect width="48" height="48" rx="6" fill="#4CAF50" />
    <text x="5" y="30" fontFamily="Arial" fontWeight="bold" fontSize="12" fill="white">M-PESA</text>
  </svg>
);
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8">
        ...
        <div className="sm:col-span-2 lg:col-span-1">
          ...
          <Link to="/" className="flex items-center gap-3 mb-5 group w-fit">
            ...
            <div className="leading-none">
              ...
              <p className="text-xs font-body mt-1 text-sand/38">East Africa</p>
            </div>
          </Link>
        ...
        <div>
          <h4 className="font-display text-sm font-semibold tracking-widest uppercase
            text-primary mb-5">Safari Types</h4>
        ...
        <div>
          <h4 className="font-display text-sm font-semibold tracking-widest uppercase
            text-primary mb-5">Destinations</h4>
          <ul className="space-y-3 font-body text-sm text-sand/55">
        ...
        <div>
          <h4 className="font-display text-sm font-semibold tracking-widest uppercase
            text-primary mb-5">Quick Links</h4>
          <ul className="space-y-3 font-body text-sm text-sand/55">
            {[
