...
const DestinationsPage = () => (
  <PageLayout>
    ...
    <PageHero
      image={tour1}
      imageAlt="Safari destinations across East Africa"
      eyebrow="Where We Take You"
      title="Destinations"
      subtitle="From the Serengeti to Kilimanjaro — explore the regions we know best."
    />
          ...
          >
            ...
            <div className={i % 2 === 1 ? "lg:order-1" : ""}>
              ...
              <div className="flex flex-wrap gap-2 mb-8">
                ...
                {dest.parks.length > 4 && (
                  <span className="font-body text-xs bg-muted px-3 py-1.5 rounded-full text-muted-foreground">
              ...
              <div className="flex items-center gap-4">
                <Link
                  ...
                  className="inline-flex items-center gap-2 px-7 py-3.5 bg-primary
                    text-primary-foreground text-xs font-semibold tracking-widest uppercase
                    rounded-full hover:bg-primary/85 transition-all duration-200 group"
                >
                ...
                <Link
                  ...
                  className="inline-flex items-center gap-2 text-xs font-body tracking-widest
                    uppercase text-muted-foreground hover:text-foreground transition-colors duration-200"
                >
                  Request a quote
                </Link>
              </div>
