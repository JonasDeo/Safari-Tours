    ...
    <PageLayout>
      <div className="min-h-screen bg-background">
        ...
        <section
          ...
          style={{ height: "clamp(180px, 35vh, 340px)" }}
        >
          <img src={heroImg} alt="Safari landscape"
            className="absolute inset-0 w-full h-full object-cover object-center" />
          <div className="absolute inset-0 bg-gradient-to-b from-black/40 to-black/70" />
          <div className="relative z-10 text-center px-4 pb-8 sm:pb-12">
            <h1 className="font-display text-3xl sm:text-4xl md:text-5xl font-bold text-sand mb-2 text-shadow-hero">
              Request a Quote
            </h1>
            <p className="font-body text-sand/65 text-sm sm:text-base">
        ...
        <div className="flex flex-col lg:flex-row min-h-screen bg-background">
          ...
          <aside
            className={[
              "relative w-full lg:w-[36%] xl:w-[32%] overflow-hidden flex flex-col",
          ...
          >
            ...
            <div className="relative z-10 flex flex-col justify-between h-full gap-6
              px-6 py-8 sm:px-8 sm:py-10 lg:px-10 lg:py-12 min-h-[220px] lg:min-h-0">
